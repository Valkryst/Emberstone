...
public class SettingsModel extends Model<SettingsController, SettingsView> {
    /*
	...
	@Override
	protected SettingsController createController() {
		return new SettingsController(this);
	}

	@Override
	protected SettingsView createView(final SettingsController controller) {
		final var view = new SettingsView(controller);
		view.setAlphaInterpolation(alphaInterpolation);
		view.setAntialiasing(antialiasing);
		view.setColorRendering(colorRendering);
    ...
    public void save() throws IOException {
        final var fileWriter = new FileWriter(SETTINGS_FILE);
    ...
    public String setAlphaInterpolation(final String alphaInterpolation) {
        switch (alphaInterpolation) {
            case "Auto":
            case "Quality":
            case "Speed": {
            ...
            default: {
				System.err.println("Attempted to set Alpha Interpolation to '" + alphaInterpolation + "', but this value is not supported.");
            }
        }
    ...
    public String setAntialiasing(final @NonNull String antialiasing) {
        switch (antialiasing) {
            case "Auto":
            case "On":
            case "Off": {
            ...
            default: {
				System.err.println("Attempted to set Antialiasing to '" + antialiasing + "', but this value is not supported.");
            }
        }
    ...
    public String setColorRendering(final @NonNull String colorRendering) {
        switch (colorRendering) {
            case "Auto":
            case "Quality":
            case "Speed": {
            ...
            default: {
				System.err.println("Attempted to set Color Rendering to '" + colorRendering + "', but this value is not supported.");
            }
        }
    ...
    public String setDithering(final @NonNull String dithering) {
        switch (dithering) {
            case "Auto":
            case "Enable":
            case "Disable": {
            ...
            default: {
				System.err.println("Attempted to set Dithering to '" + colorRendering + "', but this value is not supported.");
            }
        }
    ...
    public String setInterpolation(final @NonNull String interpolation) {
        switch (interpolation) {
            case "Bicubic":
            case "Bilinear":
            case "Nearest Neighbor": {
            ...
            default: {
				System.err.println("Attempted to set Interpolation to '" + colorRendering + "', but this value is not supported.");
            }
        }
    ...
    public String setRendering(final @NonNull String rendering) {
        switch (rendering) {
            case "Auto":
            case "Quality":
            case "Speed": {
            ...
            default: {
				System.err.println("Attempted to set CRendering to '" + colorRendering + "', but this value is not supported.");
            }
        }
    ...
    public boolean setWindowed(final boolean windowed) {
